...
#' @docType data
#' @description The HOmogenized instRUmental Seismic catalog (HORUS) of Italy
#'   from 1960 to present, limited to limited to 1960-2019.
#'
...
#'
#' @details
#' The original entire HORUS catalog is provided as a single tab separated ascii
#' file: in `HORUS_Ita_Catalog.txt` a random second decimal digit is added to ML
#' and Md of the INGV bulletin (ISIDe) before computing Mw proxies (Lolli et
#' al., Seism. Res. Lett., 91, 3208-3222, doi: 10.1785/0220200148), in
#' `HORUS_Ita_Catalog_o.txt` the original ML and Md are used to compute Mw
#' proxies. `ETAS.inlabru` includes a reformatted version of the data from
#' `HORUS_Ita_Catalog.txt` as a `data.frame`, limited to 1960-2019.
#'
...
#'   \item{`Geo.CPTI15`}{`"*"` indicates that the epicenter is within the
#'     spatial window of the CPTI15 catalog (Rovida et al., 2020, Bull Earth
#'     Eng, `doi: 10.1007/s10518-020-00818-y`)}
