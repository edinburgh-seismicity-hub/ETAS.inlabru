...
plot_triggering[[1]] <- triggering_fun_plot_priors(list.input, magnitude = 4, n.samp = 100) +
  ggtitle("C. M4 triggering function") +     
  theme_bw()  + 
  ylim(0,5.5) + 
  theme(plot.title = element_text(size = 8))

plot_triggering[[3]] <- triggering_fun_plot_priors(list.input, magnitude = 6.7, n.samp = 100) +
...
plt <- grid.arrange(plot_triggering[[1]], plot_triggering[[2]], ncol=2, nrow=1, top="Triggering function variability") + 
  theme(plot.title = element_text(size = 8))
