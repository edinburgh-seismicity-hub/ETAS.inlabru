...
plt <- grid_arrange_shared_legend(mu_priorPlot, K_priorPlot,alpha_priorPlot,c_priorPlot,p_priorPlot, plot_omori[[1]], plot_triggering[[1]], plot_triggering[[3]], ncol=3, nrow=3, position='bottom', top="Samples from the priors and triggering functions")
