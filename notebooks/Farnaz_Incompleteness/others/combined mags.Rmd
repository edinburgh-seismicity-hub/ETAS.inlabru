...
samp.scenario_6_5 <- generate_temporal_ETAS_synthetic(theta=theta, beta.p=log(10), M0=M0, T1=0, T2=modelledDuration, Ht=scenario_6_5)
samp.scenario_6_0 <- generate_temporal_ETAS_synthetic(theta=theta, beta.p=log(10), M0=M0, T1=0, T2=modelledDuration, Ht=scenario_6_0)
samp.scenario_5_0 <- generate_temporal_ETAS_synthetic(theta=theta, beta.p=log(10), M0=M0, T1=0, T2=modelledDuration, Ht=scenario_5_0)
samp.scenario_4_0 <- generate_temporal_ETAS_synthetic(theta=theta, beta.p=log(10), M0=M0, T1=0, T2=modelledDuration, Ht=scenario_4_0)
samp.scenario_mix <- generate_temporal_ETAS_synthetic(theta=theta, beta.p=log(10), M0=M0, T1=0, T2=modelledDuration, Ht=scenario_mix)
...
list.input_6_5 <- create_input_list_temporal_noCatalogue(fpath)
...
fpath <- system.file("extdata", "user_input_synthetic_noCatalogue.txt", package="ETAS.inlabru")
list.input_6_0 <- create_input_list_temporal_noCatalogue(fpath)
...
fpath <- system.file("extdata", "user_input_synthetic_noCatalogue.txt", package="ETAS.inlabru")
list.input_5_0 <- create_input_list_temporal_noCatalogue(fpath)
...
fpath <- system.file("extdata", "user_input_synthetic_noCatalogue.txt", package="ETAS.inlabru")
list.input_4_0 <- create_input_list_temporal_noCatalogue(fpath)
...
fpath <- system.file("extdata", "user_input_synthetic_noCatalogue.txt", package="ETAS.inlabru")
list.input_mix <- create_input_list_temporal_noCatalogue(fpath)
