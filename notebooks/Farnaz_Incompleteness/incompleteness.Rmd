...
conditional_intensity <- function (t){cond_lambda(theta=theta, t=t, th=th, mh=mh, M0=M0)}

# Conditional intensity after rate modification
modified_conditional_intensity <- function (t){modified_cond_lambda(theta=theta, t=t, th=th, mh=mh, M0=M0, G=G, H=H, b=b)}
