...
samp.etas.list <- generate.temoral.ETAS.synthetic(theta = theta_etas, beta.p = log(10), M0 = M0, T1 = 0, T2 = modelledDuration, Ht=Ht)

#injection.ETAS.cat <- bind_rows(samp.etas.list)
ggplot() + 
